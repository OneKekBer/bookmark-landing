      ...
      <div>
         <div className="header">
            <div className="container flex-between">
               ...
               {isNonMobileScreen576 ? (
                  <div className="header__texts flex-between">
         ...
         <div className="feat">
            <div className="container text-center">
               <h1 className="feat__title">Features</h1>
         ...
         <div className="faq">
            <div className="container flex-center text-center">
               ...
               <p className="faq__text">
                  ...
                  <br /> If you have any other questions you’d like answered
                  please feel free to email us.
               </p>
               <Box
                  className="faq__accordion"
                  sx={{ width: isNonMobileScreen767 ? "50%" : "100%" }}
               >
                  <Accordion className="acc__item" sx={{ boxShadow: "none" }}>
                     ...
                     <AccordionDetails>
                        <p style={{ margin: 0 }}>
                           ...
                           elit. Fusce tincidunt justo eget ultricies fringilla.
         ...
         <section className="stay bg-blue">
            <div className="container text-center">
               ...
               <form action="" className="stay__form" onSubmit={handleSubmit}>
                  ...
                  />
                  <button className="stay__button" type="submit">
                     Contact Us
                  </button>
               </form>
            </div>
